...
public class DijkstrasAlgorithm {
  ...
  String minDistance(HashMap<String, Double> dist, HashMap<String, Boolean> inShortest) {
  ...
  double nodeDistance(Node start, Node end) {
    return Math.sqrt(
  ...
  HashMap<String, Double> dijkstra(Graph g, String startID, ArrayList<String> goalIDs) {
