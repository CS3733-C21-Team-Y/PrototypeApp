...
public class MapController extends SubPage {
    ...
    @FXML
    private Pane adornerPane;
    @FXML
    protected StackPane containerStackPane;

    @FXML
    private GridPane mapOverlayUIGridPane;
    // @FXML private HBox overlayHBox;

    @FXML
    private JFXButton reset;
    @FXML
    private JFXNodesList floorList;
    @FXML
    private JFXButton currentFloorBtn;
